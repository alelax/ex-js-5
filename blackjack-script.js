...
var cpuScore = randomNumber(1, 21);
var userScore = 0;
var gameStatus = "risk"; // Stato del gioco ["risk", "end"]
...
do {
   var currentLaunch = randomNumber(1, 10);
   ...
   if (userScore > 21){
      ...
      do {
         var answer = prompt("Il tuo punteggio è: " + userScore + "\n\nVuoi pescare un'altra carta?\n\nSI [1]\nNO [0]");
         if ( (answer != 0) && (answer != 1) ) {
         alert("\nPuoi digitare solo SI (1) oppure NO (0) ");
         }
      } while ( (answer != 0) && (answer != 1)  );

      var carryOn = decidi(answer);
      if(!carryOn) {
         gameStatus = "end";
